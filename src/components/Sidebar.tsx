...
const Sidebar: React.FC<SidebarProps> = ({ onStartGame, onOpenSettings, onMultiplayer }) => {
  return (
    <aside className="sidebar">
      {/* Logo */}
      <div className="sidebar-logo">
        <img src={logoSrc} alt="Snooker logo" />
      </div>

      {/* Navigation */}
      <nav className="sidebar-nav">
        <button className="sidebar-btn" onClick={onStartGame}>
        ...
        <button className="sidebar-btn" onClick={onMultiplayer}>
          <span className="sidebar-icon">
      ...
      <div className="sidebar-auth">
        <button className="auth-login" onClick={() => alert('Login not implemented yet')}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
          Login
        </button>
        <button className="auth-signup" onClick={() => alert('Sign up not implemented yet')}>
